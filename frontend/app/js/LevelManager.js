...
return forca;`,
            ...
            targetMin: 100, targetMax: 900, targetStep: 50, targetDefault: 600,
            statLabels: { pos: "Posição Atual", vel: "Velocidade", err: "Distância (Erro)", ctrl: "Força Aplicada" },
        ...
        2: {
            ...
            description: "Estabilize a altitude do drone mesmo com rajadas de vento imprevisíveis!",
...
return thrust;`,
            ...
            targetMin: 20, targetMax: 80, targetStep: 5, targetDefault: 50,
            statLabels: { pos: "Altitude", vel: "Vel. Vertical", err: "Desvio", ctrl: "Empuxo" },
            statUnits: { pos: "m", vel: "m/s", err: "m", ctrl: "N" },
        ...
        3: {
            ...
            headerGradient: "linear-gradient(135deg, #0d3b59 0%, #1a6e8a 50%, #0d3b59 100%)",
            description: "Atraque o navio no cais com correntes oceânicas cíclicas perturbando sua trajetória!",
...
return rudder;`,
            ...
            targetMin: 150, targetMax: 450, targetStep: 30, targetDefault: 300,
            statLabels: { pos: "Posição Lateral", vel: "Vel. Lateral", err: "Desvio do Cais", ctrl: "Leme (Força)" },
            statUnits: { pos: "m", vel: "m/s", err: "m", ctrl: "N" },
